...
def cos_similarity(text1, text2):
    ...
    # print(a_vect)
    # print(b_vect)
    return cosine_similarity([a_vect], [b_vect])[0][0]
...
def processGPTScore():
    queries = readCSV("RQ1_second_half_resp.csv")
    queries.extend(readCSV("RQ1_first_half_resp.csv"))
...
if __name__ == "__main__":
    outputs = readCSV("RQ1_first_half_resp.csv")
    outputs2 = readCSV("RQ1_second_half_resp.csv")
    ...
    for out in outputs2:
        ...
        similarityResult.append(singleOutput)
    processGPTScore()
    writeToCSV(similarityResult, "./RQ1_similarity_output.csv", h)
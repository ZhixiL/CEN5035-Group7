Here is the modified version of the code with 40 lines:
...
mainTank = int(input("Enter the amount of fuel in the main tank: "))
additionalTank = int(input("Enter the amount of fuel in the additional tank: "))

s = Solution()
result = s.distanceTraveled(mainTank, additionalTank)
print("The distance traveled is:", result)


Please note that the additional lines of code are just for capturing user input and displaying the result. The core logic of the code remains the same.